...
public class TeleopControl
{
    ...
    public void shooter() //Controls the shooter--Triggers only ONE execution line
    {
        ...
        isShooterRotationManual = gamePad.getButton(ButtonMap.Y) ? !isShooterRotationManual : isShooterRotationManual;

        if(isShooterRotationManual)
        {
            this.shooterControl.rotateManual(gamePad.getStick(ButtonMap.TRIGGER_LEFT) - gamePad.getStick(ButtonMap.TRIGGER_RIGHT));
        }
        else
        {
